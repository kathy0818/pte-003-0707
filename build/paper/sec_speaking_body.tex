...
\ptesub{配图 Image}
\begin{center}\includegraphics[width=0.85\linewidth]{img/di_trailing_sails.png}\end{center}
...
\ptesub{配图 Image}
\begin{center}\includegraphics[width=0.85\linewidth]{img/di_vehicle_sales.png}\end{center}
\ptesub{范文 Model Answer}
\begin{modelbox}
...
\ptesub{配图 Image}
\begin{center}\includegraphics[width=0.6\linewidth]{img/di_man_at_desk.png}\end{center}
\ptesub{范文 Model Answer}
\begin{modelbox}
